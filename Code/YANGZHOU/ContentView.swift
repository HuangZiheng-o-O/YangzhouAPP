        ...
        VStack {
            TabView {
                ...
                VStack {
                    ...
                    RequirementText(iconColor: userRistrantionViewModel.isNameLengthVaild ? Color.secondary : Color(red: 123/255, green: 44/255, blue:191/255), text: "至少4个字符", isStrikeThrough: userRistrantionViewModel.isNameLengthVaild)
                        .padding()
                    FormField(fieldName: "密码", fieldValue: $userRistrantionViewModel.password, isSecure: true)
                    // 密码
                    VStack {
                        RequirementText(iconName: "lock.open", iconColor: userRistrantionViewModel.isPasswordLengthVaild ? Color.secondary : Color(red: 123/255, green: 44/255, blue:191/255), text:"至少8个字符", isStrikeThrough: userRistrantionViewModel.isPasswordLengthVaild)
                        RequirementText(iconName: "lock.open", iconColor: userRistrantionViewModel.isPasswordCapitalLetter ? Color.secondary : Color(red: 123/255, green: 44/255, blue:191/255), text: "至少1个大写字母", isStrikeThrough: userRistrantionViewModel.isPasswordCapitalLetter)
                    }
                    .padding()
                        ...
                        if( tmp.count != 1){
                           ...
                           label: {
                               Text("登录")
                                   ...
                                   .background(LinearGradient(gradient: Gradient(colors: [Color(red:70/255, green:123/255, blue: 225/255), Color(red: 123/255, green:44/255, blue: 191/255)]), startPoint: .leading, endPoint: .trailing))
                                   .cornerRadius(10)
                                   .padding(.horizontal)
                           })
...
//                            onLoginFinished(true)
                           ...
                           label:{
                               Text("注册")
                                   ...
                                   .padding()
                                   .frame(minWidth: 0, maxWidth: .infinity)
                                   .background(LinearGradient(gradient: Gradient(colors: [Color(red:20/255, green:30/255, blue: 128/255), Color(red: 60/255, green:20/255, blue: 100/255)]), startPoint: .leading, endPoint: .trailing))
                                   .cornerRadius(10)
                                   .padding(.horizontal)
                           })
